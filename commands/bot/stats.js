...
exports.run = async (client, message, args) => {
  ...
  const istatistikler = new Discord.MessageEmbed()
    .setColor("RANDOM")
    .setTimestamp()
    .setFooter("© 2021 Simqle Tech.", client.user.avatarURL())
    .addField("» **Botun Sahibi**", "<@814962555416084480>")
    ...
    .addField("**» Bot Davet**"," [Davet Et](https://discord.com/oauth2/authorize?client_id=" + client.user.id + "&scope=bot&permissions=8)");
